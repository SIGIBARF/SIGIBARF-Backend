    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(help_text='Usuario/Cliente al que pertenece el carrito', on_delete=django.db.models.deletion.CASCADE, to='usuarios.usuario')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(help_text='Usuario/Cliente que realiza el pedido', on_delete=django.db.models.deletion.CASCADE, to='usuarios.usuario')),
            ],
            options={
                'verbose_name': 'Pedido',
